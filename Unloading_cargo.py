...
while True:
    ...
    if 4 < get_distance() <= 20:
        ...
        def repeat_action():
             ...
             swift.set_position(y = 110, speed = 9e7) 
             time.sleep(3)

             swift.set_position(x = 150, speed = 9e7)
             time.sleep(3)

             swift.set_position(y = 90, speed = 9e7)
             time.sleep(3)
        ...
        for contours1 in range(len(find_contours)): # i:第幾個物體 # contours1:第幾個輪廓
            ...
            time.sleep(3)
            swift.set_position(x = 160, speed = 9e7) 
            time.sleep(3)
            ...
            swift.set_position(z = 40, speed = 9e7)
            time.sleep(3)
            ...
            if corners == 3: # shape_type = "三角形"
                swift.set_position(y = 130 + random_value, speed = 9e7)
                time.sleep(3) 
             
                repeat_action()
            elif corners == 4: # shape_type = "矩形" 
                swift.set_position(y = 140 + random_value, speed = 9e7)
                time.sleep(3) 
             
                repeat_action()
            elif 5 <= corners <= 15: # shape_type = "圓形"
                swift.set_position(y = 150 + random_value, speed = 9e7)
                time.sleep(3) 
             
                repeat_action()
            else: # shape_type = "無法辨識"
                swift.set_position(y = 160 + random_value, speed = 9e7)
                time.sleep(3) 
